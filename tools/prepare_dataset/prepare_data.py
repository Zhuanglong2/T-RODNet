...
def parse_args():
    ...
    parser.add_argument('--config', default=r'E:\PycharmProjects\T-RODNet-main\configs\config_T_Rodnet_win16.py',type=str, dest='config', help='configuration file path')
    parser.add_argument('--data_root',default='E:\RADAR\mnt\disk1\CRUW\ROD2021', type=str,
    ...
    parser.add_argument('--split', type=str,default='train',  dest='split',
